...
- Screenshots (1280×800) — exactly five, matching the five store slots:
  1. `screenshot-1-live-1280x800.png` — a rule firing on a live page, toolbar popup open over it
  2. `screenshot-2-before-after-1280x800.png` — same page, injections paused vs applied
  3. `screenshot-3-dashboard-1280x800.png` — options dashboard (rule list, MCP panel, backups)
  4. `screenshot-4-editor-1280x800.png` — rule editor, with the Live CSS Sync control zoomed
  5. `screenshot-5-mcp-1280x800.png` — AI MCP bridge
